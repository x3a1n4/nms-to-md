...
exports.variableSignatureRegExp = exports.constructorSignatureRegExp = exports.functionSignatureRegExp = exports.classSignatureRegExp = exports.namespaceSignatureRegExp = exports.newLineRegExp = void 0;
exports.parseNamespaceFile = parseNamespaceFile;
exports.parseDocument = parseDocument;
exports.newLineRegExp = /\r?\n/;
exports.namespaceSignatureRegExp = /^\s*@namespace\s+([a-zA-Z][a-zA-Z0-9_]*|__default__)\s*$/;
exports.classSignatureRegExp = /^\s*@class\s+([A-Z][a-zA-Z0-9_]*)\s*$/;
exports.functionSignatureRegExp = /^\s*(?:((?:[a-zA-Z][a-zA-Z0-9_]*::)?[A-Z][a-zA-Z0-9_]*(?:\[\])?)\s+)?([a-z][a-zA-Z0-9_]*)\s*(\(.*\))\s*$/;
exports.constructorSignatureRegExp = /^\s*([A-Z][a-zA-Z0-9_]*)\s*(\(.*\))\s*$/;
exports.variableSignatureRegExp = /^\s*((relative\s+)?(final\s+)?(relative\s+)?((?:[a-zA-Z][a-zA-Z0-9_]*::)?[A-Z][a-zA-Z0-9_]*(?:\[\])?)\s+([a-z][a-zA-Z0-9_]*))\s*(=.*)?$/;
...
function parseNamespaceFile(text, namespaceStorage, classStorage) {
    const lines = text.split(exports.newLineRegExp);
    for (let i = 0; i < lines.length; i++) {
        const regExpRes = exports.namespaceSignatureRegExp.exec(lines[i]);
        if (regExpRes === null)
            continue;
        let j = i;
...
function parseNamespace(name, lines, classStorage) {
    ...
    for (let i = 0; i < lines.length; i++) {
        const classRegExpRes = exports.classSignatureRegExp.exec(lines[i]);
...
function parseVariableOrFunctionAtLine(namePrefix, lines, line) {
    const functionRegExpRes = exports.functionSignatureRegExp.exec(lines[line]);
    const constructorRegExpRes = exports.constructorSignatureRegExp.exec(lines[line]);
    const variableRegExpRes = exports.variableSignatureRegExp.exec(lines[line]);
